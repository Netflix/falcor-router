...
describe('Materialized Paths.', function() {
    ...
    describe('#get', function() {
        ...
        it('should validate that when part of the requested set is matched, and part is fulfilled by onUnhandledGet.', function(done) {
            var router = partialRouter();
            router.onUnhandledGet(function unhandledGet(paths) {
                return [{
                    path: ['one', 1],
                    value: $ref(['two', 'be', 100])
                }, {
                    path: ['two', 'be', 100, 'summary'],
        ...
        it('should validate that when part of the requested set is matched, and part is fulfilled by onUnhandledGet (async).', function(done) {
            var router = partialRouter();
            router.onUnhandledGet(function unhandledGet(paths) {
                return Observable.
                    return([{
